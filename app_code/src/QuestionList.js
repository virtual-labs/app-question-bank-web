    ...
    const fetchQuestions = async () => {
      try {
        ...
        if ((selectedTag.length !== 0 && selectedDifficulty && qemail)) {
          ...
          const data = await fetch_requests(`http://vlabs-question-bank.el.r.appspot.com/api/questions?tags=${passing}&difficulty=${selectedDifficulty}&user=${qemail}`);
          ...
          const passing = tagArray.join(",")
          // if ((questionData.selectedTags.includes(String(selectedTag.label)) && questionData.difficulty == selectedDifficulty))
          const data = await fetch_requests(`http://vlabs-question-bank.el.r.appspot.com/api/questions?tags=${passing}&user=${qemail}`);
          //  console.log(data.data.questions);
          questionList = data.data.questions;
        }
          ...
          const passing = tagArray.join(",")
          // if ((questionData.selectedTags.includes(String(selectedTag.label)) && questionData.difficulty == selectedDifficulty))
          const data = await fetch_requests(`http://vlabs-question-bank.el.r.appspot.com/api/questions?tags=${passing}&difficulty=${selectedDifficulty}`)
          //  console.log(data.data.questions);
          questionList = data.data.questions;
        }
          ...
          const data = await fetch_requests(`http://vlabs-question-bank.el.r.appspot.com/api/questions?difficulty=${selectedDifficulty}&user=${qemail}`);
          // console.log(data.data.questions);
          questionList = data.data.questions;
        }
          ...
          const data = await fetch_requests(`http://vlabs-question-bank.el.r.appspot.com/api/questions?difficulty=${selectedDifficulty}`);
          // console.log(data.data.questions);
          questionList = data.data.questions;
        }
        else {
          ...
          const data = await fetch_requests(`http://vlabs-question-bank.el.r.appspot.com/api/questions?user=${qemail}`);
          // console.log(data.data.questions);
          questionList = data.data.questions;
        }
